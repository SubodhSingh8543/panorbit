...
const SingleProductPage = () => {
    ...
    console.log(filt);
    return (
        <Box display={"flex"} border={"0px solid red"} h={"auto"} m={"20px"} gap={"10px"}>
            ...
            <Box w={"100%"} border={"0px solid green"} minH={"800px"}>
                ...
                {active === "Profile" && <Box border={"0px solid red"} display={"flex"} h={"65%"} borderTop={"none"} mt={"30px"}>
                    <Box w={"35%"} h={"100%"} >
                    ...
                    <Box w={"65%"} h={"100%"} borderLeft={"1px solid grey"}>
                ...
                {active !== "Profile" && <Flex justifyContent={"center"} alignItems={"center"} h="700px" >
